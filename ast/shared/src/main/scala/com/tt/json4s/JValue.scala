...
sealed abstract class JValue extends Diff.Diffable with Product with Serializable {
  ...
  /**
   * When this [[com.tt.json4s.JValue]] is a [[com.tt.json4s.JNothing]] or a [[com.tt.json4s.JNull]], this method returns [[scala.None]]
  ...
  /**
   * When this [[com.tt.json4s.JValue]] is a [[com.tt.json4s.JNothing]], this method returns [[scala.None]]
   * When it has a value it will return [[scala.Some]]
   */
