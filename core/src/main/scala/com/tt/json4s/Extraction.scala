...
import com.tt.json4s
import com.tt.json4s.prefs.ExtractionNullStrategy
import com.tt.json4s.reflect._
...
object Extraction {
   ...
   * @see com.tt.json4s.JsonAST.JValue#extract
   ...
   * implicit val formats: Formats = com.tt.json4s.DefaultFormats
   ...
   * Load lazy val value
   *
   * This is a fix for failed lazy val serialization from FieldSerializer (see com.tt.json4s.native.LazyValBugs test).
   *
