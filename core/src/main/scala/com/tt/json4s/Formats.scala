...
import com.tt.json4s.prefs.EmptyValueStrategy
 ...
 */
@implicitNotFound(
  "No com.tt.json4s.Formats found. Try to bring an instance of com.tt.json4s.Formats in scope or use the com.tt.json4s.DefaultFormats."
)
