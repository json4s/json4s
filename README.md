# JSON4S [![Build Status](https://travis-ci.org/json4s/json4s.svg?branch=3.2)](https://travis-ci.org/json4s/json4s)
...
![Json AST](https://raw.github.com/json4s/json4s/3.2/core/json.png)
...
* http://repo1.maven.org/maven2/org/json4s/json4s-core_2.9.3/3.2.11/json4s-core_2.9.3-3.2.11.jar
* http://repo1.maven.org/maven2/org/json4s/json4s-native_2.9.3/3.2.11/json4s-native_2.9.3-3.2.11.jar
...
* [ext](https://github.com/json4s/json4s/tree/3.2/ext)

Support for Enum, Joda-Time, ...

* [scalaz](https://github.com/json4s/json4s/tree/3.2/scalaz)

Applicative style parsing with Scalaz

* [native-lift](https://github.com/json4s/json4s/tree/3.2/native-lift)
...
Please see more examples in [MergeExamples.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/MergeExamples.scala) and [DiffExamples.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/DiffExamples.scala).
...
Please see more examples in [JsonQueryExamples.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/JsonQueryExamples.scala).
...
java.util.Dates.
Please see more examples in [ExtractionExampleSpec.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/ExtractionExamplesSpec.scala).
...
solutions for this (see [LottoExample.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/LottoExample.scala) for bigger example).
...
Please see other examples in [SerializationExamples.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/native/SerializationExamples.scala).
...
Please see more examples in [XmlExamples.scala](https://github.com/json4s/json4s/blob/3.2/tests/src/test/scala/org/json4s/XmlExamples.scala).
